...
public class CertDate {
    ...
    private ContentsChecker.Estado validAdd = ContentsChecker.Estado.sin_cambios;
    ...
    public void setValidAdd(ContentsChecker.Estado validAdd) {
        this.validAdd = validAdd;
    }

    public ContentsChecker.Estado getValidAdd() {
        return validAdd;
    }
